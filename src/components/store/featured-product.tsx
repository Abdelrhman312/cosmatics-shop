  ...
  return (
    <section className="bg-muted py-16 md:py-24">
      <div className="container grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-border bg-white dark:bg-zinc-900 p-6 md:p-8">
          ...
          <p className="mt-4 text-zinc-600 dark:text-zinc-300">{featured.description}</p>
        ...
        <div className="mt-6 flex gap-4 overflow-x-auto pb-2">
          {products.map((product) => (
            <motion.div
              whileHover={{ y: -4 }}
              key={product.id}
              className="min-w-[220px] rounded-xl border border-border bg-white dark:bg-zinc-900 p-3"
            >
