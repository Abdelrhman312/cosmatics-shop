  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container max-w-3xl">
        ...
        {orderId ? (
          <div className="mt-8 rounded-xl border border-border bg-white dark:bg-zinc-900 p-6 space-y-4">
            <h2 className="text-xl font-semibold">Order placed successfully</h2>
            <p className="text-sm text-zinc-600 dark:text-zinc-400">Order ID: {orderId}</p>
            {whatsappLink ? (
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6 rounded-xl border border-border bg-white dark:bg-zinc-900 p-6">
            ...
            {paymentMethod === "manual_transfer" ? (
              <div className="rounded-lg border border-border bg-muted dark:bg-zinc-800 p-4 space-y-3 text-sm">
